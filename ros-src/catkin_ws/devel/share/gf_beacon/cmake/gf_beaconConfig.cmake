...
if(NOT "/opt/geofrenzy/src/catkin_ws/devel/include " STREQUAL " ")
  set(gf_beacon_INCLUDE_DIRS "")
  set(_include_dirs "/opt/geofrenzy/src/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gf_beacon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/geofrenzy/src/catkin_ws/src/gf_beacon/${idir}'.  Ask the maintainer 'root <chris.stradtman@geo.netwpork>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /opt/geofrenzy/src/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
